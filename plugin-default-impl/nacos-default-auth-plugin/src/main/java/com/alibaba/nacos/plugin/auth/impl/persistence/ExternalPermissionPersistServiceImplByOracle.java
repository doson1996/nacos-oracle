...
/**
 * 如果指定了数据库为oracle，则这个bean设置为primary
 * Implemetation of ExternalPermissionPersistServiceImpl.
 *
 * @author ds
 */
@Primary
@ConditionalOnProperty(value = "spring.sql.init.platform", havingValue = "oracle")
@Conditional(value = ConditionOnExternalStorage.class)
@Component
public class ExternalPermissionPersistServiceImplByOracle implements PermissionPersistService {
